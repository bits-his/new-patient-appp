                      ...
                      >
                        ...
                        <td style={centerColumnStyle} className="text-center">
                          {editting ? (
                            <input
                              size="sm"
                              className="form-control form-control-sm result-input-with-ref"
                              value={item.result}
                              style={{ width: 80 }}
                              onChange={(e) =>
                                handleInputChange(
                        ...
                        <td style={rightColumnStyle} className="text-center">
                          {/* {item.n_range_from}
                          {JSON.stringify(checkStrEmpty(item.n_range_from.toString()))} */}
                          {editting ? (
                            <Input
                              size="sm"
