...
function PharmacyDashboard() {
  ...
  const syncData = useCallback(() => {
    ...
    dispatch(getAllReport(setDebts, dateInfo.from, dateInfo.to, 'Debt summary'))
    ...
    <Card body className='container'>
      ...
      <Row>
        <Widget
          fa="fa-store"
          id={0}
          link={`/me/pharmacy/dashboard-view?route=Purchase category summary&from=${dateInfo.from}&to=${dateInfo.to}`}
        ...
        <Widget
          fa="fa-credit-card"
          id={0}
          link={`/me/pharmacy/dashboard-view?route=Sales category summary&from=${dateInfo.from}&to=${dateInfo.to}`}
          title="Total sales"
          content={`₦ ${
            sales.length
              ? sales[0].total
        ...
        <Widget
          fa="fa-briefcase"
          id={0}
          link={`/me/pharmacy/dashboard-view?route=Discount category summary&from=${dateInfo.from}&to=${dateInfo.to}`}
        ...
        {/* <Widget
          fa="fa-briefcase"
          id={0}
          link={`/me/pharmacy/dashboard-view?route=Debt category summary?from=${dateInfo.from}&to=${dateInfo.to}`}
          title="Total debts"
          content={`₦ ${
            debts.length
              ? debts[0].total
