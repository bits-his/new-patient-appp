          ...
          <div>
            {patientDetails.name !== undefined && (
              <>
                ...
                <CustomButton
                  ...
                  onClick={() =>
                    history.push(
                      `/me/doctor/surgical-note/new?patient_id=${patientDetails.id}&patient_name=${patientDetails.name}`
                    )
                  }
                >
            ...
            <CustomButton
              ...
              onClick={() => {
                // history.goBack();
                history.push(
                  `/me/doctor/past-records/${patientDetails.id}?view_type=Consultation`
                );
              }}
            >
            ...
            <CustomButton
              ...
              onClick={() =>
                history.push(
                  `/me/doctor/operation-notes/new/${patientDetails.id}?section=disabled&patient_id=${patientDetails.id}&show_back=true`
                )
              }
            >
            ...
            <CustomButton
              ...
              onClick={() =>
                history.push(
                  `/me/doctor/visits/new-summary/${patientDetails.id}?section=disabled&patient_id=${patientDetails.id}&show_back=true`
                )
              }
            >
              <IoMdDocument size={20} className="mr-2" />
