          ...
          <CustomButton
            ...
            onClick={() => {
              ...
              if (isNursingModule) {
                ...
                // );
                history.push(
                  `/me/nurse/nursing-requests/${item.patient_id}?page_type=preview&patient_id=${item.patient_id}&allocation_id=${item.allocation_id}&page_type=preview&section=disabled`,
                )
              } else {
                // history.push(
                ...
                history.push(
                  ...
                  `/me/doctor/visit-preview/${item.patient_id}?page_type=preview&visit_id=&patient_id=${item.patient_id}&allocation_id=${item.allocation_id}&page_type=preview&section=disabled`,
                )
              }
            }}
          >
